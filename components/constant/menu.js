export const MENUITEMS = [
      {
      title: 'All items', megaMenu: true, megaMenuType: 'small', type: 'sub', children: [
         {
   ...
   {
      title: 'Gifting', type: 'sub', children: [
   ...
   {
      title: 'Decoration', type: 'sub', children: [
         {
   ...
   {
      title: 'collections', megaMenu: true, megaMenuType: 'small', type: 'sub', children: [
         {
            title: 'Portfolio', type: 'sub', children: [
               { path: '/portfolio/grid-2', title: 'Portfolio Grid 2', type: 'link', icon: 'alert' },
               { path: '/portfolio/grid-3', title: 'Portfolio Grid 3', type: 'link', icon: 'layout-accordion-merged' },
